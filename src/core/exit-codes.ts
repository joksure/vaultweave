 ...
 *   1  FAILED      the run was incomplete or failed (see .sheaf-run-report.json), or bad configuration
 *   2  NOT_IMPLEMENTED  the command exists in the CLI surface but is not built yet
 *   3  LOCKED      another sheaf run holds the lock for this output directory; nothing was done
 */
export const EXIT = {
  OK: 0,
  FAILED: 1,
